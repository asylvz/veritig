...
void Concordance::run_mapping(parameters& params)
{
	...
	minimap_cmd = "minimap2 -cx " + shell_quote(params.minimap_preset) + " -t " + threads_str + " " + shell_quote(params.haplo1_assembly_path) + " " + shell_quote(params.svtig1_path) + " --secondary=no > " + shell_quote(this->paf_H1_svtig1_path) + " 2>/dev/null";
	run_command(minimap_cmd, this->paf_H1_svtig1_path);
	std::cerr << " done\n";

	std::cerr << "  Mapping svtig1 to H2...";
	minimap_cmd = "minimap2 -cx " + shell_quote(params.minimap_preset) + " -t " + threads_str + " " + shell_quote(params.haplo2_assembly_path) + " " + shell_quote(params.svtig1_path) + " --secondary=no > " + shell_quote(this->paf_H2_svtig1_path) + " 2>/dev/null";
	...
	if (params.phase)
	{
		...
		minimap_cmd = "minimap2 -cx " + shell_quote(params.minimap_preset) + " -t " + threads_str + " " + shell_quote(params.haplo1_assembly_path) + " " + shell_quote(params.svtig2_path) + " --secondary=no > " + shell_quote(this->paf_H1_svtig2_path) + " 2>/dev/null";
		run_command(minimap_cmd, this->paf_H1_svtig2_path);
		std::cerr << " done\n";

		std::cerr << "  Mapping svtig2 to H2...";
		minimap_cmd = "minimap2 -cx " + shell_quote(params.minimap_preset) + " -t " + threads_str + " " + shell_quote(params.haplo2_assembly_path) + " " + shell_quote(params.svtig2_path) + " --secondary=no > " + shell_quote(this->paf_H2_svtig2_path) + " 2>/dev/null";
